;(function($, document, window, undefined) {
    $(function() {
        ...
        jcmp.AddEvent('toggle_admin_star_ui', (networkId, toggle) => {
            var player = findPlayer(networkId);
            player.isAdmin = toggle;
            destroyPlayer(networkId);
            addPlayer(player);
        });

        jcmp.AddEvent('unnick_player_ui', (networkId, originalName) => {
            var player = findPlayer(networkId);
        ...
        jcmp.AddEvent('nick_player_ui', (networkId, nick) => {
            var player = findPlayer(networkId);
            player.name = nick;
            destroyPlayer(networkId);
            addPlayer(player);
