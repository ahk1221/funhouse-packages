...
jcmp.events.AddRemoteCallable('nick_player_remote', (networkId, nick) => {
    jcmp.ui.CallEvent('nick_player_ui', networkId, nick);
    playersCache.forEach(function(element) {
...
jcmp.events.AddRemoteCallable('unnick_player', (networkId, originalName) => {
    jcmp.ui.CallEvent('unnick_player_ui', networkId, originalName);
    playersCache.forEach(function(element) {
        if(element.id === networkId) {
...
jcmp.events.AddRemoteCallable('toggle_admin_star', (toggle, networkId) => {
    jcmp.ui.CallEvent('toggle_admin_star_ui', networkId, toggle);
    playersCache.forEach(function(element) {
        if(element.id === networkId) {
            element.flags.isAdmin = toggle;
        }
    }, this);
});
